...
public class CashInDTO {
	...
	public CashInDTO(int id, Date recordDate, Double amount, String remarks, Clients client, Designations designation) {
		super();
		this.id = id;
	...
	public CashInDTO(Date recordDate, Double amount, String remarks, Clients client, Designations designation) {
		super();
		this.recordDate = recordDate;
		this.amount = amount;
		this.remarks = remarks;
