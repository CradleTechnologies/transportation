...
public class DesignationsDataFilter implements Specification<Designations> {

	String userQuery;
	
	public DesignationsDataFilter(String queryString) {
		this.userQuery = queryString;
	}
	
	@Override
	public Predicate toPredicate(Root<Designations> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
