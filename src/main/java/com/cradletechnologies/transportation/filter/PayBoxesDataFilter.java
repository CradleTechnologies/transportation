...
public class PayBoxesDataFilter implements Specification<PayBoxes> {

	String userQuery;
	
	public PayBoxesDataFilter(String queryString) {
		this.userQuery = queryString;
	}
	
	@Override
	public Predicate toPredicate(Root<PayBoxes> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
